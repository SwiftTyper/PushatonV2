...
class PredictionViewModel: ObservableObject {
    ...
    func setupConditionMonitoring(onConditionMetAction: @escaping () -> Void) {
...
//                    self.resetConditionMetTimer()
    ...
    private func startConditionMetTimer(onConditionMetAction: @escaping () -> Void) {
...
extension PredictionViewModel: VideoProcessingChainDelegate {
    func videoProcessingChain(
        _ chain: VideoProcessingChain,
